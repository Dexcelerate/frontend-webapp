			...
			<div class="row-1">
				<div class="boxes">
					<div class="box box-has-nft">
						<div class="body">
							<div class="item">
							<a href="https://bscscan.com/token/${DATA.USERS_NFT}?a=${(DATA.conf.N?.JBU?.length && DATA.conf.N.JBU[0].id) ?? footer.dataset.nft}" target="_blank"><img src="${DATA.ERROR_USER_IMG}" onerror="error_user_img(this)" data-user-image="true" data-action="mint"></a>
