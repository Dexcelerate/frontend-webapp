...
const get_chain_user = async () => {
	let chain_user_last_payment, chain_user_affiliate, chain_user_no_fee, chain_user_avatar, chain_user_plan, chain_user_sell_fee, chain_user_price, chain_user_addr, chain_user_pool, chain_user_router, chain_user_avatars, chain_user_path, chain_user_safe, chain_user_stop, chain_user_exists;
	...
	await Promise.all([
		...
		(async () => {
			try {
				[chain_user_last_payment, chain_user_affiliate, chain_user_no_fee, chain_user_avatar, chain_user_plan, chain_user_sell_fee, chain_user_price, chain_user_addr, chain_user_pool, chain_user_router, chain_user_avatars, chain_user_path, chain_user_safe, chain_user_stop, chain_user_exists] = await contract(DATA.USERS).getUser(DATA.conf.wallet);
			} catch(e) {
				return false;
			}
		})()
